...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.1.LTS
...
.dlls,em4f .dlls: tcpEcho.pem4f

-include package/cfg/tcpEcho_pem4f.mak
-include package/cfg/tcpEcho_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tcpEcho_pem4f.dep
endif
tcpEcho.pem4f: package/cfg/tcpEcho_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
tcpEcho.pem4f package/cfg/tcpEcho_pem4f.c: .libraries,em4f
endif

package/cfg/tcpEcho_pem4f.c package/cfg/tcpEcho_pem4f.h package/cfg/tcpEcho_pem4f.xdl: override _PROG_NAME := tcpEcho.xem4f
package/cfg/tcpEcho_pem4f.c: package/cfg/tcpEcho_pem4f.cfg
package/cfg/tcpEcho_pem4f.xdc.inc: package/cfg/tcpEcho_pem4f.xdl
package/cfg/tcpEcho_pem4f.xdl package/cfg/tcpEcho_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/tcpEcho_pem4f.cfg
	-$(RM) package/cfg/tcpEcho_pem4f.dep
	-$(RM) package/cfg/tcpEcho_pem4f.c
	-$(RM) package/cfg/tcpEcho_pem4f.xdc.inc

clean,em4f::
	-$(RM) tcpEcho.pem4f
.executables,em4f .executables: tcpEcho.xem4f

tcpEcho.xem4f: |tcpEcho.pem4f

-include package/cfg/tcpEcho.xem4f.mak
tcpEcho.xem4f: package/cfg/tcpEcho_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/tcpEcho_pem4f.oem4f   package/cfg/tcpEcho_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
tcpEcho.xem4f: export C_DIR=
tcpEcho.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
tcpEcho.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

tcpEcho.test test,em4f test: tcpEcho.xem4f.test

tcpEcho.xem4f.test:: tcpEcho.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tcpEcho.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tcpEcho.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,tcpEcho.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
tcpEcho_pem4f.oem4f,copy : package/cfg/tcpEcho_pem4f.oem4f
tcpEcho_pem4f.sem4f,copy : package/cfg/tcpEcho_pem4f.sem4f
